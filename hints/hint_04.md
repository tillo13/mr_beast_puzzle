...
| Feb 10-11 | User chats with Slackbot (rate-limited after 6 messages) |
| Feb 11 | User creates 11 vault cards, earns "10 Cards" milestone |
| **Feb 12** | **Slackbot publicly announced to all players** |
| Feb 13 | User's rate limit clears, resumes chatting |
...
✅ **Understanding of rate limits** — Know the 2-3 day reset pattern
...
- **Rate limit timeline:** `sources/salesforce_hub/slackbot_chats/RATE_LIMIT_DEFINITIVE.md`
- **HAR analysis:** `docs_global/har/` (discovery documentation)
